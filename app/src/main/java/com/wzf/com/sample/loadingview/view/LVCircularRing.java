package com.wzf.com.sample.loadingview.view;
...
//        mPaint.setColor(Color.argb(100, 255, 255, 255));
        canvas.drawCircle(mWidth / 2, mWidth / 2, mWidth / 2 - mPadding, mCPaint);
//        mPaint.setColor(Color.WHITE);
    ...
    private void initPaint() {
        ...
        mCPaint.setColor(Color.argb(100, 255, 255, 255));
