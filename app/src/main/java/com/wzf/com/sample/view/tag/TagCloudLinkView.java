package com.wzf.com.sample.view.tag;
/*
...
public class TagCloudLinkView extends RelativeLayout {
    ...
    private void initialize(Context ctx, AttributeSet attrs, int defStyle) {
        ...
        deleteDrawbleRes = typeArray.getResourceId(R.styleable.TagCloudLinkView_deletDrawbleRes, -1);
        typeArray.recycle();
    }
    ...
    public void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            // inflate tag layout
            View tagLayout = mInflater.inflate(R.layout.tag, null);//一个字项
            ...
            if (mIsDeletable) {
                ...
                tagWidth += deletableView.getMeasuredWidth();
                ...
                deletableView.measure(width, height);
                int w = deletableView.getMeasuredWidth();
                tagWidth += w;
